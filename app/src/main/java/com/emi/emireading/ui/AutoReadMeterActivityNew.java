...
public class AutoReadMeterActivityNew extends BaseActivity implements View.OnClickListener {
    ...
    private static class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            final AutoReadMeterActivityNew activity = (AutoReadMeterActivityNew) mWeakReference.get();
            if (activity != null) {
                switch (msg.what) {

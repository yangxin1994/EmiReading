package com.emi.emireading.core.callback;
...
import com.emi.emireading.core.adapter.BaseItemDraggableEmiAdapter;
...
//    private static final String TAG = ItemDragAndSwipeCallback.class.getSimpleName();
    ...
    BaseItemDraggableEmiAdapter mAdapter;
    ...
    public ItemDragAndSwipeCallback(BaseItemDraggableEmiAdapter adapter) {
        mAdapter = adapter;
    }
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (actionState == ItemTouchHelper.ACTION_STATE_DRAG
            ...
            viewHolder.itemView.setTag(R.id.EmiBaseAdapter_dragging_support, true);
        } else if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE
                && !isViewCreateByAdapter(viewHolder)) {
            mAdapter.onItemSwipeStart(viewHolder);
            viewHolder.itemView.setTag(R.id.EmiBaseAdapter_swiping_support, true);
        }
    ...
    public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        if (viewHolder.itemView.getTag(R.id.EmiBaseAdapter_dragging_support) != null
                && (Boolean)viewHolder.itemView.getTag(R.id.EmiBaseAdapter_dragging_support)) {
            mAdapter.onItemDragEnd(viewHolder);
            viewHolder.itemView.setTag(R.id.EmiBaseAdapter_dragging_support, false);
        }
        if (viewHolder.itemView.getTag(R.id.EmiBaseAdapter_swiping_support) != null
                && (Boolean)viewHolder.itemView.getTag(R.id.EmiBaseAdapter_swiping_support)) {
            mAdapter.onItemSwipeClear(viewHolder);
            viewHolder.itemView.setTag(R.id.EmiBaseAdapter_swiping_support, false);
        }
    }

...
import com.emi.emireading.core.utils.SizeUtil;
import com.emi.emireading.widget.view.radius.RadiusTextView;
...
public class ToastUtils {
    ...
    public static void show(int content, boolean isShowRunningForeground, Builder builder) {
        if (null == sContext) {
            throw new NullPointerException(EmiConstants.EXCEPTION_NOT_INIT);
        }
    ...
    private static void showToast(CharSequence content, boolean isShowRunningForeground, Builder builder) {
        ...
        boolean needShow = !isShowRunningForeground || (isShowRunningForeground && EmiUtils.isRunningForeground(sContext));
        if (needShow) {
            sSystemToast.show();
        }
    }

    public static void showToastSuccess(CharSequence msg) {
    ...
    public static void showToastFailed(CharSequence msg) {
        show(msg, sIsShowRunningForeground, getFailedBuilder());
    }

    public static void showToastFailed(int msg) {
        show(msg, sIsShowRunningForeground, getFailedBuilder());
    }

    public static void showToastWarning(CharSequence msg) {
    ...
    public static void showToastNormal(String msg) {
        show(msg, ToastUtils.newBuilder().setGravity(Gravity.CENTER));
    }

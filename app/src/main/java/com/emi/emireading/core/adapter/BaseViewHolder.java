...
/**
 * @author :zhoujian
 * @description : 基类ViewHolder
 * @company :翼迈科技
 * @date: 2017年07月06日上午 10:11
...
public  class BaseViewHolder extends RecyclerView.ViewHolder{
    ...
    private BaseEmiAdapter adapter;
    ...
    public BaseViewHolder setText(@IdRes int viewId, CharSequence value,int color) {
        TextView view = getView(viewId);
        view.setText(value);
        view.setTextColor(ContextCompat.getColor(EmiReadingApplication.getAppContext(), color));
        return this;
    }
    ...
    public BaseViewHolder setText(@IdRes int viewId, @StringRes int strId,int color) {
        TextView view = getView(viewId);
        view.setText(strId);
        view.setTextColor(ContextCompat.getColor(EmiReadingApplication.getAppContext(), color));
        return this;
     ...
     * @return The BaseViewHolder for chaining.
     */
    protected BaseViewHolder setAdapter(BaseEmiAdapter adapter) {

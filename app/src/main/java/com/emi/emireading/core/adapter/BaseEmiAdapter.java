...
import com.emi.emireading.common.BaseMultiTypeDelegate;
import com.emi.emireading.core.animation.AlphaInAnimation;
import com.emi.emireading.core.animation.BaseAnimation;
import com.emi.emireading.core.animation.ScaleInAnimation;
import com.emi.emireading.core.animation.SlideInBottomAnimation;
...
/**
 * @author :zhoujian
 * @description : 基类适配器（基于BRVAH修改）
 * @company :翼迈科技
 * @date 2017年07月15日下午 02:07
 * @Email: 971613168@qq.com
 */
public abstract class BaseEmiAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    /**
     *  加载更多
     */
    ...
    protected static final String TAG = BaseEmiAdapter.class.getSimpleName();
    ...
    /**
     * @return Whether the ChannelInfoEmiAdapter is actively showing load
     * progress.
     */
     ...
     */
    public BaseEmiAdapter(@LayoutRes int layoutResId, @Nullable List<T> data) {
    ...
    public BaseEmiAdapter(@Nullable List<T> data) {
        this(0, data);
    }

    public BaseEmiAdapter(@LayoutRes int layoutResId) {
    ...
    protected int getDefItemViewType(int position) {
        if (mBaseMultiTypeDelegate != null) {
            return mBaseMultiTypeDelegate.getDefItemViewType(mData, position);
        }
    ...
    /**
     * Load more without data when icon_settings are clicked loaded
     *
     * @param enable
     */
    ...
    private void bindViewClickListener(final BaseViewHolder baseViewHolder) {
        ...
        if (getOnItemClickListener() != null) {
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    getOnItemClickListener().onItemClick(BaseEmiAdapter.this, v, baseViewHolder.getLayoutPosition() - getHeaderLayoutCount());
                }
            });
        }
        if (getOnItemLongClickListener() != null) {
            view.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    return getOnItemLongClickListener().onItemLongClick(BaseEmiAdapter.this, v, baseViewHolder.getLayoutPosition() - getHeaderLayoutCount());
                }
            });
        }
    }

    private BaseMultiTypeDelegate<T> mBaseMultiTypeDelegate;

    public void setBaseMultiTypeDelegate(BaseMultiTypeDelegate<T> baseMultiTypeDelegate) {
        mBaseMultiTypeDelegate = baseMultiTypeDelegate;
    }

    public BaseMultiTypeDelegate<T> getBaseMultiTypeDelegate() {
        return mBaseMultiTypeDelegate;
    }

    protected K onCreateDefViewHolder(ViewGroup parent, int viewType) {
        int layoutId = mLayoutResId;
        if (mBaseMultiTypeDelegate != null) {
            layoutId = mBaseMultiTypeDelegate.getLayoutId(viewType);
        }
    ...
    /**
     * When the current adapter is empty, the BaseEmiAdapter can display a special view
    ...
    public interface OnItemChildClickListener {
         ...
         */
        void onItemChildClick(BaseEmiAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemChildLongClickListener {
         ...
         */
        boolean onItemChildLongClick(BaseEmiAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         * @return true if the callback consumed the long click ,false otherwise
         */
        boolean onItemLongClick(BaseEmiAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(BaseEmiAdapter adapter, View view, int position);
    }

package com.emi.emireading.widget.view.pickerview;

import android.content.Context;
import android.view.View;

import com.emi.emireading.R;
import com.emi.emireading.widget.view.pickerview.adapters.NumericWheelAdapter;
import com.emi.emireading.widget.view.pickerview.config.PickerConfig;
import com.emi.emireading.widget.view.pickerview.data.source.TimeRepository;
...
import com.emi.emireading.widget.view.pickerview.wheel.OnWheelChangedListener;
import com.emi.emireading.widget.view.pickerview.wheel.WheelView;
...
public class TimeWheel {
    ...
    void initYear() {
        ...
        mYearAdapter = new NumericWheelAdapter(mContext, minYear, maxYear, PickerConstant.FORMAT, mPickerConfig.mYear);
    ...
    void updateMonths() {
        ...
        mMonthAdapter = new NumericWheelAdapter(mContext, minMonth, maxMonth, PickerConstant.FORMAT, mPickerConfig.mMonth);
    ...
    void updateDays() {
        ...
        int minDay = mRepository.getMinDay(curYear, curMonth);
        mDayAdapter = new NumericWheelAdapter(mContext, minDay, maxDay, PickerConstant.FORMAT, mPickerConfig.mDay);
    ...
    void updateHours() {
        ...
        mHourAdapter = new NumericWheelAdapter(mContext, minHour, maxHour, PickerConstant.FORMAT, mPickerConfig.mHour);
    ...
    void updateMinutes() {
        ...
        mMinuteAdapter = new NumericWheelAdapter(mContext, minMinute, maxMinute, PickerConstant.FORMAT, mPickerConfig.mMinute);

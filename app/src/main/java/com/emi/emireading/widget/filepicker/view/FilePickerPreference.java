...
/**
 * @author :zhoujian
 * @description : 文件选择Preference
 * @company :翼迈科技
 * @date 2019年01月29日上午 11:10
 * @Email: 971613168@qq.com
 */

public class FilePickerPreference extends Preference implements DialogSelectListener, Preference.OnPreferenceClickListener {
    ...
    private void initProperties(AttributeSet attrs) {
        ...
        for (int i = 0; i < N; ++i) {
            ...
            if (attr == R.styleable.FilePickerPreference_selection_mode) {
                properties.selectMode = tarr.getInteger(R.styleable.FilePickerPreference_selection_mode, BaseDialogConfig.SINGLE_MODE);
            } else if (attr == R.styleable.FilePickerPreference_selection_type) {
                properties.selectType = tarr.getInteger(R.styleable.FilePickerPreference_selection_type, BaseDialogConfig.SELECT_FILE);
                ...
                if (error_dir != null && !error_dir.equals("")) {
                    properties.errorDir = new File(error_dir);
                }

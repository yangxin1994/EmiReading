 ...
 * @company :翼迈科技
 * @date: 2017年08月29日上午 10:01
 * @Email: 971613168@qq.com
 */

public class EmiProgressBar extends View implements Runnable {
    ...
    public EmiProgressBar(Context context) {
        this(context, null, 0);
    }

    public EmiProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EmiProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initAttrs(attrs);
    }

    private void initAttrs(AttributeSet attrs) {
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.EmiProgressBar);
        try {
            textSize = (int) ta.getDimension(R.styleable.EmiProgressBar_textSize, 12);
            loadingColor = ta.getColor(R.styleable.EmiProgressBar_loadingColor, Color.parseColor("#40c4ff"));
            stopColor = ta.getColor(R.styleable.EmiProgressBar_stopColor, Color.parseColor("#ff9800"));
            radius = (int) ta.getDimension(R.styleable.EmiProgressBar_radius, 0);
            borderWidth = (int) ta.getDimension(R.styleable.EmiProgressBar_progressBorderWidth, 1);
        } finally {
            ta.recycle();
        }
    }

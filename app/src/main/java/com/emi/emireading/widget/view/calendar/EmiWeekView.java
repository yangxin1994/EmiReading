...
/**
 * @author :zhoujian
 * @description : 自定义日历顶部星期 View
 * @company :翼迈科技
 * @date 2018年07月05日下午 01:45
 * @Email: 971613168@qq.com
 */

public class EmiWeekView extends View {
    ...
    public EmiWeekView(Context context) {
        this(context, null);
    }

    public EmiWeekView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EmiWeekView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.EmiWeekView);
        int textColor = a.getColor(R.styleable.EmiWeekView_ewv_textColor, Color.BLACK);
        setTextColor(textColor);
        int textSize = a.getDimensionPixelSize(R.styleable.EmiWeekView_ewv_textSize, -1);

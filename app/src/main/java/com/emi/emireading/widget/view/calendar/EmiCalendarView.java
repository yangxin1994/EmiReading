 ...
 * @author :zhoujian
 * @company :翼迈科技
 * @date: 2018年07月05日上午 10:51
 * @description: 自定义可多选日历View
 * @Email: 971613168@qq.com
 */

public class EmiCalendarView extends View {
    ...
    public interface OnDataClickListener {
         ...
         * @param day   对应的日.
         */
        void onDataClick(@NonNull EmiCalendarView view, int year, int month, int day);
    }
    ...
    public interface OnDateChangeListener {
         ...
         * @param day    对应的日.
         */
        void onSelectedDayChange(@NonNull EmiCalendarView view, boolean select, int year, int month, int day);
    }

    public EmiCalendarView(Context context) {
        this(context, null);
    }

    public EmiCalendarView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EmiCalendarView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.EmiCalendarView);

        int textColor = a.getColor(R.styleable.EmiCalendarView_ecv_textColor, Color.BLACK);
        setTextColor(textColor);

        int selectTextColor = a.getColor(R.styleable.EmiCalendarView_ecv_selectTextColor, Color.BLACK);
        setSelectTextColor(selectTextColor);

        float textSize = a.getDimension(R.styleable.EmiCalendarView_ecv_textSize, sp2px(14));
        setTextSize(textSize);

        float selectTextSize = a.getDimension(R.styleable.EmiCalendarView_ecv_selectTextSize, sp2px(14));
        setSelectTextSize(selectTextSize);

        Drawable dayBackground = a.getDrawable(R.styleable.EmiCalendarView_ecv_dayBackground);
        setDayBackground(dayBackground);

        Drawable selectDayBackground = a.getDrawable(R.styleable.EmiCalendarView_ecv_selectDayBackground);
        setSelectDayBackground(selectDayBackground);

        String pattern = a.getString(R.styleable.EmiCalendarView_ecv_dateFormatPattern);
        setDateFormatPattern(pattern);

        boolean isChange = a.getBoolean(R.styleable.EmiCalendarView_ecv_isChangeDateStatus, false);

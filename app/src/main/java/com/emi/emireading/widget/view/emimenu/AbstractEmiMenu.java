...
public abstract class AbstractEmiMenu<E, T extends MenuBaseAdapter> implements LifecycleObserver {
    ...
    protected AbstractEmiMenu(Context context) {
        initialize(context);
    }

    protected AbstractEmiMenu(Context context, AbstractMenuBuilder builder) {
        initialize(context);
    ...
    public void showPopup(View anchor) {
        if (showBackground) {
            backgroundWindow.showAtLocation(anchor, Gravity.CENTER, 0, 0);
            isShowing = true;
        }
    }
    ...
    public int getContentViewHeight() {
        ...
        if (height == 0) {
            ...
            if (getHeaderView() != null) {
                height += getHeaderView().getMeasuredHeight();
            }
            if (getFooterView() != null) {
                height += getFooterView().getMeasuredHeight();
            }
            return height;
        } else {
            return height;
    ...
    public void setAnimation(MenuAnimation menuAnimation) {
        ...
        } else if (menuAnimation == MenuAnimation.SHOW_UP_BOTTOM_LEFT) {
            menuWindow.setAnimationStyle(R.style.ShowUpAnimation_BL);
        } else if (menuAnimation == MenuAnimation.SHOW_UP_BOTTOM_RIGHT) {
            menuWindow.setAnimationStyle(R.style.ShowUpAnimation_BR);
        } else if (menuAnimation == MenuAnimation.SHOW_UP_TOP_LEFT) {
            menuWindow.setAnimationStyle(R.style.ShowUpAnimation_TL);
        } else if (menuAnimation == MenuAnimation.SHOW_UP_TOP_RIGHT) {
